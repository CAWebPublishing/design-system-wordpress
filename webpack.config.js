...
let entries = {
  ...
  "campaign": [
    ...
    '@cagovweb/go-site-header/src/images/cagov-icon-newsom-gradient-container.png',
    '@cagovweb/go-site-header/src/images/cagov-logo-newsom-gradient-container.svg',
    '@cagovweb/go-site-header/src/images/cagov-logo-newsom-gradient-container-hover.svg',
