...
let entries = {
  ...
  "campaign": [
    ...
    '@cagovweb/go-site-header/src/images/cagov-icon-newsom-gradient.svg',
    '@cagovweb/go-site-header/src/images/cagov-logo-flag-gradient-container.svg',
    '@cagovweb/go-site-header/src/images/cagov-logo-flag-gradient-container-hover.svg',
