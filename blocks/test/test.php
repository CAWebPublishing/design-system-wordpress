...
/**
 * Plugin Name:       Test
 * Plugin URI:        https://github.com/CAWebPublishing/test
...
if ( ! defined('Test_URI') ){
	$cagov_design_system_test_doc_root = isset( $_SERVER['DOCUMENT_ROOT'] ) ? sanitize_text_field( wp_unslash( $_SERVER['DOCUMENT_ROOT'] ) ) : '';
	define( 'Test_URI', esc_url( str_replace( $cagov_design_system_test_doc_root, '', __DIR__ ) ) );
}
...
// Include Test Core Functionality.
 ...
 */
add_action( 'init', 'cagov_design_system_test_init' );

if ( ! function_exists( 'cagov_design_system_test_init' ) ) {
	/**
	 * Test Initialization
	 *
	 ...
	 * @return void
	 */
	function cagov_design_system_test_init() {
		global $pagenow;
