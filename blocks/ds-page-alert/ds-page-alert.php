	...
	function cagov_design_system_ds_page_alert_init() {
		...
		*/
		...
		if ( in_array( $pagenow, array( 'post.php', 'post-new.php' ), true ) ) {
			...
			wp_enqueue_style( 'cagov-design-system-ds-page-alert', cagov_design_system_ds_page_alert_get_min_file( '/css/ds-page-alert.css' ), array(), $version );
		}
...
if ( ! function_exists( 'cagov_design_system_ds_page_alert_wp_enqueue_scripts' ) ) {
	...
	function cagov_design_system_ds_page_alert_wp_enqueue_scripts() {
		...
		wp_enqueue_script( 'cagov-design-system-ds-page-alert', cagov_design_system_ds_page_alert_get_min_file( '/js/ds-page-alert.js', 'js' ), array(), $version, true );
