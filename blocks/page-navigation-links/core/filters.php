...
add_filter( 'script_loader_tag', 'cagov_design_system_page_navigation_links_script_loader_tag', 10, 3 );
...
if ( ! function_exists( 'cagov_design_system_block_categories' ) ) {
	/**
	 * Register Page Navigation Links Gutenberg Block categories to the Block editor
	 *
...
if ( ! function_exists( 'cagov_design_system_allowed_block_types' ) ) {
	/**
	 * Page Navigation Links Allowed Block Types
	 *
	 * Removes all blocks or patterns from Gutenberg and returns Page Navigation Links Blocks.
	 *
...
if ( ! function_exists( 'cagov_design_system_page_navigation_links_script_loader_tag' ) ) {
	/**
	 ...
	 * @return string
	 */
	function cagov_design_system_page_navigation_links_script_loader_tag( $tag, $handle, $src ) {
		// Register script as module.
		if ( 'cagov-design-system-page-navigation-links' === $handle ) {
			$tag = sprintf( '<script type="module" id="cagov-design-system-page-navigation-links-js" src="%1$s"></script>', $src );
		}
