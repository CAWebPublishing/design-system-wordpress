...
add_filter( 'script_loader_tag', 'caweb_page_navigation_links_script_loader_tag', 10, 3 );
...
if( ! function_exists('caweb_page_navigation_links_script_loader_tag') ){
	/**
	...
	* @return string
	*/
	function caweb_page_navigation_links_script_loader_tag( $tag, $handle, $src ) {
		// Register script as module.
		if ( 'caweb-page-navigation-links' === $handle ) {
			$tag = sprintf('<script type="module" id="caweb-page-navigation-links-js" src="%1$s"></script>', $src);
		}
