...
/**
 * Plugin Name:       Curvy
 * Plugin URI:        https://github.com/CAWebPublishing/curvy
 * Description:       Curvy Gutenberg Block
 * Version:           1.3.0
...
if ( ! defined('Curvy_URI') ){
	$cagov_design_system_curvy_doc_root = isset( $_SERVER['DOCUMENT_ROOT'] ) ? sanitize_text_field( wp_unslash( $_SERVER['DOCUMENT_ROOT'] ) ) : '';
	define( 'Curvy_URI', esc_url( str_replace( $cagov_design_system_curvy_doc_root, '', __DIR__ ) ) );
}
...
// Include Curvy Core Functionality.
 ...
 */
add_action( 'init', 'cagov_design_system_curvy_init' );

if ( ! function_exists( 'cagov_design_system_curvy_init' ) ) {
	/**
	 * Curvy Initialization
	 *
	 ...
	 * @return void
	 */
	function cagov_design_system_curvy_init() {
		global $pagenow;
