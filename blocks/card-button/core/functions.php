<?php
/**
 * Card Button Helper Functions
 *
 * @package cagov-design-system
 */

if ( ! function_exists( 'cagov_design_system_card_button_get_min_file' ) ) {
	/**
	 ...
	 * @return string
	 */
	function cagov_design_system_card_button_get_min_file( $f, $ext = 'css' ) {
		...
		if ( ! CAGOV_DESIGN_SYSTEM_DEBUG && file_exists( __DIR__ . str_replace( ".$ext", ".min.$ext", $f ) ) ) {
			return CardButton_URI . str_replace( ".$ext", ".min.$ext", $f );
		} else {
			return CardButton_URI . $f;
		}
	}
}
