...
/**
 * Plugin Name:       Card
 * Plugin URI:        https://github.com/CAWebPublishing/card
 * Description:       Card Gutenberg Block
 * Version:           1.3.0
...
if ( ! defined('Card_URI') ){
	$cagov_design_system_card_doc_root = isset( $_SERVER['DOCUMENT_ROOT'] ) ? sanitize_text_field( wp_unslash( $_SERVER['DOCUMENT_ROOT'] ) ) : '';
	define( 'Card_URI', esc_url( str_replace( $cagov_design_system_card_doc_root, '', __DIR__ ) ) );
}
...
// Include Card Core Functionality.
 ...
 */
add_action( 'init', 'cagov_design_system_card_init' );

if ( ! function_exists( 'cagov_design_system_card_init' ) ) {
	/**
	 * Card Initialization
	 *
	 ...
	 * @return void
	 */
	function cagov_design_system_card_init() {
		global $pagenow;
